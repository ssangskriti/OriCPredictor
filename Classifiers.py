...
tuned_parameters = [{'kernel': ['rbf'], 'gamma': [0.01,0.005,1e-2, 1e-4],
...
for train_index, test_index in cv.split(X, y):
    ...
    model = vm.SVC(kernel='rbf', gamma=0.001, C=200, probability=True#LogisticRegression()#GaussianNB()#RandomForestClassifier()#AdaBoostClassifier()#svm.SVC(kernel='linear', gamma=0.01, C=1000, probability=True)
